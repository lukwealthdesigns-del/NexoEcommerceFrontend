...
//       // Check follow status - IMPORTANT: use the is_following from API response
//       const followingStatus = data.is_following === true;
//       setIsFollowing(followingStatus);
//       console.log('Is following from API:', followingStatus);
      
//       const userProducts = await usersService.getUserProducts(userId);
...
//       if (isFollowing) {
//         // Unfollow
//         console.log('Attempting to unfollow:', targetUserId);
...
//       } else {
//         // Follow
//         console.log('Attempting to follow:', targetUserId);
//         await usersService.followUser(targetUserId);
//         setIsFollowing(true);
//         setFollowersCount(prev => prev + 1);
//         toast.success(`Now following ${profile?.first_name}`);
//       }
//     } catch (error) {
...
//       // Refresh profile to get latest follow status
...
//                 className="px-5 py-1.5 rounded-full bg-gray-700 text-white text-sm font-semibold flex items-center gap-2"
//               >
...
//         {/* Stats Row - Products, Followers, Following, Sales */}
...
//         {/* Products Section */}
//         <div>
//           <h2 className="text-white font-semibold mb-3">{products.length} Products</h2>
